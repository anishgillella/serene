    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      try {
        ...
        if (e2 instanceof ConnectionError) {
          ...
          throw new ConnectionError("Could not fetch region settings, ".concat(e2 instanceof Error ? "".concat(e2.name, ": ").concat(e2.message) : e2), ConnectionErrorReason.ServerUnreachable, 500);
        }
      } finally {
        unlock();
      }
